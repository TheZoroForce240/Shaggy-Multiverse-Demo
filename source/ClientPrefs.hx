...
class ClientPrefs {
	...
	public static var showScoreText:Bool = false; //idk why youd wanna hide it but whatever
	...
	public static function saveSettings() {
		...
		FlxG.save.data.newpauseMusic = pauseMusic;

		FlxG.save.data.showScoreText = showScoreText;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.showScoreText != null) {
			showScoreText = FlxG.save.data.showScoreText;
		}
		...
		if(FlxG.save.data.newpauseMusic != null) {
			pauseMusic = FlxG.save.data.newpauseMusic;
		}
