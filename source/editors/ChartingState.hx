	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			...
			*/
			...
			if (FlxG.keys.justPressed.RIGHT && !vortex && !FlxG.keys.pressed.ALT || FlxG.keys.justPressed.D)
				changeSection(curSection + shiftThing);
			if (FlxG.keys.justPressed.LEFT && !vortex && !FlxG.keys.pressed.ALT || FlxG.keys.justPressed.A) {
				if(curSection <= 0) {
