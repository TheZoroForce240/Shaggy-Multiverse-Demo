...
class FunkinLua {
	...
	public function initHaxeInterp()
	{
		if(haxeInterp == null)
		{
			...
			haxeInterp.variables.set('ShaderFilter', ShaderFilter);
			...
			//stupid bullshit function
			haxeInterp.variables.set('getRGB', function(Red:Int, Green:Int, Blue:Int, Alpha:Int = 255)
			{
